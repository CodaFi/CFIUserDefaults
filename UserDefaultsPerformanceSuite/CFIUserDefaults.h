 ...
 * The notification object is the <i>CFIUserDefaults</i> object. This notification does not contain a 
 * userInfo dictionary."
 * -Apple docs from 2012
 */
FOUNDATION_EXPORT NSString * const CFIUserDefaultsDidChangeNotification;
 ...
 */
@interface CFIUserDefaults : NSObject
...
@interface CFIUserDefaults (CFISubscripting)
 ...
 * flushing for us.
 */
@interface CFIUserDefaults (CFIDeprecated)
